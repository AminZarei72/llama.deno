...
// int llama_bootstrap(const char *model_path, void* state_pr, int32_t n_ctx, bool f16memory, bool alpaca, bool gpt4all)
    // load the model
    {
        ...
        llama_state* state = (llama_state*) global_state_pr;
...
/* ========================= */
    // llama_state state = *(llama_state*) llama_allocate_state();
//   const modelBuffer = new TextEncoder().encode(model)
//   gpt_params params = llama_bootstrap(
//     modelBuffer,
//     state,
//     opts.ContextSize, /* C.int(mo.ContextSize) */
//     true,
//     false,
//     true,
//   )
...
*/
    ...
    //  char* input = (char*) malloc(sizeof(char) * (strlen("text") + 1)) 
    // return 0;
    

    //    const char*  ret =(char*) "thisIsAMsgFromCpp"+ret_;
...
int llama_allocate_state() {
    global_state_pr=new llama_state;
    // return global_state_pr;
    return 0;
}
...
void* llama_allocate_params(const char *prompt, int seed, int threads, int tokens, int top_k,
    ...
    // char* convertedText = (char*) malloc(sizeof(char) * 5);
    // std::wstring_convert<std::codecvt_utf8_utf16<char16_t>, char16_t> converter;
    // std::u16string text = u"text";
    // std::string utf8Text = converter.to_bytes(text);
    // const char* finalCText = utf8Text.c_str();
    // char* finalCText = (char*) malloc(sizeof(char) * (strlen("text") + 1));
    // strcpy(finalCText, "text");
    // strcpy(convertedText, "Hello, world!")

//   std::cout << "Value of text pointer: " << (void*)text << std::endl;
//   std::cout << "Value of text: " << text << std::endl;

    //  char c = 'hello how are you today?';
    // char* ptr = &c;

    // fprintf(stderr, "word'%s'\n",prompt.c_str());
    // char *promptTmp='hello how are you today?';
    params->prompt = prompt;
